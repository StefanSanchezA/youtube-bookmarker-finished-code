...
chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => {
  ...
  if(tab.url){
        ...
        // Exceptions
        if ((tab.url.includes("market") || tab.url.includes("riandoris") || tab.url.includes("OmachiPham") || tab.url.includes("AndrewHuberman")|| tab.url.includes("hubermanlab") || tab.url.includes("RianDoris") || tab.url.includes("AlexHormozi") || tab.url.includes("https://www.youtube.com/watch?v=yLUqkgpSw7Y&t=39892"))) {
